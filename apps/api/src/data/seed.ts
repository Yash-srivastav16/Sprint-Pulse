...
export const memberPulses: MemberPulse[] = [
  ...
  },
  {
    ...
    tickets: [
      { key: "SP-101", title: "Sprint health cards", status: "Review", daysIdle: 1 },
      { key: "SP-108", title: "Risk badge variants", status: "In Progress", daysIdle: 2 }
    ],
    git: {
      commitsThisSprint: 9,
      pullRequestsOpen: 1,
  ...
  },
  {
    ...
    tickets: [
      { key: "SP-104", title: "Dashboard API", status: "In Progress", daysIdle: 2 },
      { key: "SP-111", title: "GitHub signal adapter", status: "Todo", daysIdle: 4 },
      { key: "SP-112", title: "Jira signal adapter", status: "Todo", daysIdle: 4 }
    ],
    git: {
      commitsThisSprint: 4,
      pullRequestsOpen: 2,
