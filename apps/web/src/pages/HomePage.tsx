        ...
        <div className="public-hero-copy">
          ...
          <div className="public-hero-actions">
            <Link className="primary-button" to={isAuthenticated ? "/projects" : "/login"}>
              <ArrowRight size={18} />
              <span>{isAuthenticated ? "Open projects" : "Sign in to workspace"}</span>
            </Link>
            {isAuthenticated ? (
